...
declare type SwitchChangeHandler = (event: React.ChangeEvent<HTMLInputElement>, checked: boolean) => any;
...
export declare function getSwitchLabelProps({ disabled, multiline }?: SwitchProps): {
    className: string;
};
export declare function getSwitchInputProps({ label, disabled, multiline, checked, ...rest }?: SwitchProps): {
    error?: boolean | undefined;
    required?: boolean | undefined;
    onBlur?: import("react").FocusEventHandler<Element> | undefined;
    onChange?: import("react").ChangeEventHandler<HTMLInputElement> | SwitchChangeHandler | undefined;
