...
import { IBodyTranslations, IPaginationTranslations, ITableHeaderTranslations, ITableTranslations, IToolbarTranslations } from ".";
interface ToolbarSharedProps {
    readonly?: boolean;
    selectableRows?: "none" | "single" | "multiple";
}
export declare type TableToolbarProps<T extends Record<string, any>> = {
...
export declare type TableHeaderProps<T extends Record<string, any>> = {
    translations: ITableHeaderTranslations;
} & TableHeaderBodySharedProps<T>;
export declare type TableBodyProps<T extends Record<string, any>> = {
    translations: IBodyTranslations;
} & TableHeaderBodySharedProps<T>;
export declare type TableProps<T extends Record<string, any>> = {
    caption?: string;
    id?: string;
...
} & ToolbarSharedProps & TableOptions<T> & Pick<TableBodyProps<T>, "handleRowToggled">;
export declare type PaginationProps<T extends Record<string, any>> = {
    instance: TableInstance<T>;
