...
export declare type ActionType = "ENTER_SUB_MENU" | "ACTIVATE_MENU_ITEM" | "";
...
export declare type MenuChildrenType = ReactElement<MenuItemProps | SubMenuProps | MenuSeparatorProps>[];
...
export declare type MenuIndexesType = {
    index?: number;
    id?: string;
    length?: number;
}[];
