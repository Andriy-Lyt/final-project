 ...
 */
export declare function getAvatarFigureProps({ size, variant, border, label, image, initials, status, // HACK: should use proper typings to remove this field from props
...rest }?: AvatarProps): {
...
export declare function getAvatarStatusProps({ status }?: AvatarProps): {
    className: string;
};
export declare function getAvatarImageProps({ image, label }?: AvatarProps): {
    className: string;
